...
public class ConfirmDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    reference.child(username).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(ConfirmDetailsActivity.this, "Error checking existing data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        backToHome.setOnClickListener(v -> {
            Intent intent = new Intent(ConfirmDetailsActivity.this, HomePageActivity.class);
        ...
        if (user != null) {
            reference.child(user.getText().toString()).setValue(driverLicence).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(ConfirmDetailsActivity.this, "Driver Licence Updated Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ConfirmDetailsActivity.this, HomePageActivity.class);
            ...
            Toast.makeText(ConfirmDetailsActivity.this, "User field is null", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void addNewRecord(DriverLicence driverLicence) {
        if (user != null) {
            reference.child(user.getText().toString()).setValue(driverLicence).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(ConfirmDetailsActivity.this, "Driver Licence Saved Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ConfirmDetailsActivity.this, HomePageActivity.class);
                    intent.putExtra("userName", user.getText().toString());
                    startActivity(intent);
                }
        ...
        storageRef.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    // Handle the error
                    Toast.makeText(ConfirmDetailsActivity.this, "Error uploading image", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
